...
<div class="home_featured">
    <div class="home_featured_content container content">
        <div class="home_featured_header">
    ...
    <div class="home_featured_app">
        <img src="{{asset('/assets/images/home-app.jpg')}}" alt="CafeControl" title="CafeControl" />
    </div>
</div>
            ...
            <article class="radius">
                <header>
                    <img alt="Contas a receber" title="Contas a receber"
                        src="{{asset('/assets/images/home_receive.jpg')}}" />
            ...
            <article class="radius">
                <header>
                    <img alt="Contas a pagar" title="Contas a pagar"
                        src="{{asset('/assets/images/home_pay.jpg')}}" />
            ...
            <article class="radius">
                <header>
                    <img alt="Controle e relatórios" title="Controle e relatórios"
                        src="{{asset('/assets/images/home_control.jpg')}}" />
...
<article class="home_video">
    ...
    <div class="home_video_modal j_modal_close">
        <div class="home_video_modal_box">
            <div class="embed">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/uDqgcsK8Kbc?si=EI9nQdCVc3FCsInP" 
    ...
    <div class="content content">
        <div class="empty_content">
            <img class="empty_content_cover" title="Empty Content" alt="Empty Content"
                src="{{asset('/assets/images/empty-content.jpg')}}" />
