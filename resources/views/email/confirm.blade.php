@extends('layouts._theme-email')

@section('title', 'Confirme e ative sua conta no CaféControl')

@section('content')
<h2>Seja bem-vindo(a) ao CaféControl {{Auth::user()->first_name}}. Vamos confirmar seu cadastro?</h2>
